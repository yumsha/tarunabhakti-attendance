...
export default function SidebarContainer({ currentPath, currentClass }) {
  ...
  useEffect(() => {
    ...
    // Check if we are in kehadiran page to open menu
    if (currentPath && currentPath.includes("/dashboard/kehadiran")) {
        setIsMenuOpen(true);
    }
  }, [currentPath]);
