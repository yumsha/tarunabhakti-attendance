            ...
            <div className="flex-1 overflow-auto p-6">
                ...
                <div className="flex gap-5 mb-5">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between min-w-[200px] w-[200px]">
                        ...
                        <RealtimeClock />
                        <button className="mt-6 flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-colors w-full justify-center">
